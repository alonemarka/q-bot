...
# ====================== AYARLAR ======================
BOT_TOKEN = "8597974338:AAEiJvJrHY-Ae4HYAZWoZky-31axSuppS9I"   # Token burada açık
...
async def quote_handler(message: Message):
    ...
    await message.answer_photo(photo=FSInputFile(file_path), caption="✨ QuotLy Bot")
...
async def broadcast_start(callback: CallbackQuery, state: FSMContext):
    if callback.from_user.id not in ADMIN_IDS:
        return
    await callback.message.answer("📢 Toplu duyuru için mesajınızı yazın:")
...
async def main():
    ...
    print("🚀 QuotLy Bot Tek Dosya Modunda Çalışıyor!")
